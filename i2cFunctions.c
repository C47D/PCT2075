...
void I2CReadBytes(uint8_t devAddr, uint8_t regAddr, uint8_t length, uint8_t *value) {
	uint8_t i=0;
	I2C_MasterSendStart(devAddr, I2C_MPU6050_I2C_WRITE_XFER_MODE);
	I2C_I2CMasterWriteByte(regAddr);
	I2C_I2CMasterSendRestart(devAddr, I2C_MPU6050_I2C_READ_XFER_MODE);
	while (i++ < (length-1)) {
